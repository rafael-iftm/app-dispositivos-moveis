...
```bash
git clone https://github.com/rafael-iftm/estudo-dirigido-banco-de-dados-firebase-com-react-native-rafael-iftm
```

```bash
cd estudo-dirigido-banco-de-dados-firebase-com-react-native-rafael-iftm 
```
